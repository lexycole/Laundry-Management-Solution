...
Route::post('online_payment', 'App\Http\Controllers\PaymentMethodController@online_payment');
...
Route::post('customer/about_us', 'App\Http\Controllers\CustomerController@about_us');
Route::post('customer/add_feedback', 'App\Http\Controllers\CustomerController@add_feedback');
Route::post('customer/get_services', 'App\Http\Controllers\CustomerController@get_services');
Route::post('customer/get_fares', 'App\Http\Controllers\CustomerController@get_fares');
Route::post('calculate_subtotal', 'App\Http\Controllers\OrderController@calculate_subtotal');
Route::post('get_notification_list', 'App\Http\Controllers\CustomerController@get_notification_list');

//Subscripions
Route::post('get_subscription_packages', 'App\Http\Controllers\CustomerController@get_subscription_packages');
Route::post('buy_subscription', 'App\Http\Controllers\CustomerController@buy_subscription');
